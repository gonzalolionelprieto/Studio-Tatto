  ...
  return (
      <div className="container py-5 form" id='form'>
          <div className="row">
                ...
                <div className="col-6 form-container d-flex flex-column  justify-content-end align-items-center">
                        <form className='col-8 d-flex flex-column justify-content-center ms-auto'>
                ...
                <div className="col-4 mb-2 me-auto  d-flex flex-column align-items-center border-dark">
